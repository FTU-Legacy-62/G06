                ...
                <div class="input-grid">
                    <div class="form-group" style="grid-column:1 / -1;">
                        ...
                        <div class="mc-options">
                            <label class="mc-option"><input type="radio" name="n_simulations" value="100"><span>100</span></label>
                            <label class="mc-option"><input type="radio" name="n_simulations" value="500"><span>500</span></label>
...
function updateProgress() {
    ...
    let progress = Math.round((elapsed / estimatedMs) * 92);

    if (computeDone) {
        progress = 100;
    } else {
        // Never show 100% before the backend simulation has actually finished.
    ...
    if (computeDone) {
        ...
        setStage(100);
        setTimeout(function(){ window.location.href = "/result"; }, 280);
        return;
    }

    const remainingByEstimate = Math.ceil((estimatedMs - elapsed) / 1000);
    document.getElementById("timeLeft").innerText = Math.max(1, remainingByEstimate);
    setStage(progress);
